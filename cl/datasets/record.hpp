...
namespace ClusLib {
    ...
    private:
        /**The schema for a dataset is shared by all the records in the dataset. Hence, don not need
         * to make a deep copy of record, so no need of copy constructor or assignment operator.
         */
