...
class Schema : public Container<boost::shared_ptr<AttrInfo> > {
     ...
     */
  public:
    /**Since Schema contains virtual functions, its destructor is also
     * virtual.*/
    virtual ~Schema() {}
    ...
    /**since those function depends on Record class, we implement those two
     * methods in the source file of class Record*/
